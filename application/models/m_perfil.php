...
class M_perfil extends CI_Model{
	...
	function datosPersonales(){
		$sql = "SELECT lc.idcliente as idcliente,lc.idlogin_cliente as idlogin,lc.usuario as user,
				dp.dni as dni, c.valoracion as valoracion, c.foto as foto,
				...
				WHERE lc.idcliente = c.idcliente AND c.idcliente = dp.id_persona AND lc.idlogin_cliente = ?;";
